...
<body class="bg-gray-100">
    ...
    <nav class="p-6 bg-gray-800 text-white flex justify-between mb-5">
        <ul class="flex items-center font-semibold">
            @if (auth()->user())
            <li>
                <a href="{{route('student_dashboard')}}" class="p-3">Home</a>
            </li>
            @else
            <li>
        ...
        <ul class="flex items-center font-semibold">
            ...
            <li>
                <button aria-label="dropdown" class="focus:outline-none border-b-2 border-transparent focus:border-white py-3  focus:text-indigo-700 text-gray-600 hover:text-indigo-700 flex items-center relative" onclick="dropdownHandler(this)">
                    <ul class="hidden p-2 w-40 border-r bg-white absolute rounded right-0 shadow top-0 mt-16 z-50">
                        ...
                        <li onclick="location.href='{{route('enrolledcourses')}}'" class="cursor-pointer text-gray-600 text-sm leading-3 tracking-normal mt-2 py-2 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none flex items-center">
                            <a href="{{route('enrolledcourses')}}" class="focus:underline focus:text-indigo-700 focus:outline-none flex items-center">
                            ...
                            <span class="ml-2">Enrolled Courses</span>
                        </a>
                        </li>
                        <li onclick="location.href='{{route('browsecourses')}}'" class="cursor-pointer text-gray-600 text-sm leading-3 tracking-normal mt-2 py-2 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none flex items-center">
                            <a href="{{route('browsecourses')}}" class="focus:underline focus:text-indigo-700 focus:outline-none flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-help" width="20" height="20" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z"></path>
                                <circle cx="12" cy="12" r="9"></circle>
                                <line x1="12" y1="17" x2="12" y2="17.01"></line>
                            ...
                            <span class="ml-2">Browse Courses</span>
                        </a>
                        </li>
                        <li onclick="location.href='{{route('listcert')}}'" class="cursor-pointer text-gray-600 text-sm leading-3 tracking-normal mt-2 py-2 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none flex items-center">
                            <a href="{{route('listcert')}}" class="focus:underline focus:text-indigo-700 focus:outline-none flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-help" width="20" height="20" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z"></path>
                                <circle cx="12" cy="12" r="9"></circle>
                                <line x1="12" y1="17" x2="12" y2="17.01"></line>
                            ...
                            <span class="ml-2">My Credentials</span>
                        </a>
                        </li>
            ...
            @else
            <li>
                <form action="{{route('studentlogin')}}" method="GET">
                    @csrf
