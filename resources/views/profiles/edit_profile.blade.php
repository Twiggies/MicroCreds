          ...
          <form action="{{route('saveprofile')}}" method="POST" enctype="multipart/form-data" class="flex flex-col space-y-8">
            ...
            <div class="flex flex-col space-y-4 md:space-y-0 md:flex-row md:space-x-4">
              ...
              <div class="form-item w-full">
                ...
                <input type="text" name="firstname"  id="firstname" value="{{ucfirst(auth()->user()->firstname)}}" class="w-full appearance-none text-black rounded shadow py-1 px-2 mr-2 focus:outline-none focus:shadow-outline focus:border-blue-200" >
              </div>
  
              <div class="form-item w-full">
                <label class="text-xl ">Lastname</label>
                <input type="text" name="lastname" id="lastname" value="{{ucfirst(auth()->user()->lastname)}}" class="w-full appearance-none text-black rounded shadow py-1 px-2 mr-2 focus:outline-none focus:shadow-outline focus:border-blue-200" >
              </div>
            </div>
            ...
            <div class="flex flex-col space-y-4 md:space-y-0 md:flex-row md:space-x-4">
                <div class="form-item w-1/3">
                    ...
                    <input type="text" disabled value="{{auth()->user()->email}}" class="w-full appearance-none text-black text-opacity-50 rounded shadow py-1 px-2 mr-2 focus:outline-none focus:shadow-outline focus:border-blue-200" >
                </div>
            </div>
            ...
            <div class="flex flex-col space-y-4 md:space-y-0 md:flex-row md:space-x-4">
                <div class="form-item w-1/3">
                    ...
                    <input type="text" name="institute" id="institute" value="{{$profile->institute}}" class="w-full appearance-none text-black rounded shadow py-1 px-2 mr-2 focus:outline-none focus:shadow-outline focus:border-blue-200" >
                </div>
            </div>    
            @endif
            ...
            <div class="form-item">
              ...
              <input type="text" name="linkedin" id="linkedin" placeholder="www.linkedin.com/" value="{{$profile->linkedin}}" class="w-full appearance-none text-black rounded shadow py-1 px-2 mr-2 focus:outline-none focus:shadow-outline focus:border-blue-200" >
            </div>
