...
<div class="md:grid md:grid-cols-4 md:gap-6">
    <div class="mt-5 md:mt-0 md:col-span-2 md:col-start-2">
        <form action="{{route('librarychanges', $library)}}" method="POST">
        @csrf
        @method('PUT')
          <div class="shadow sm:rounded-md sm:overflow-hidden">
              ...
              <div class="grid grid-cols-3 gap-6">
                <div class="col-span-3 sm:col-span-2">
                  ...
                  <div class="mt-1 flex rounded-md shadow-sm">
                    ...
                    border-gray-300 @error('libraryname') border-red-500 @enderror" value="{{$library->name}}"
                    placeholder="Name">
                  </div>
                  @error('libraryname')
            ...
            <div class="px-4 py-3 bg-gray-50 text-right sm:px-6">
                <a class="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md" href="{{route('viewlibrary', $library)}}">Cancel</a>
